...
let Player1 = new Player("Gunjan", 100, 10);
let Player2 = new Player("Soham", 100, 10);
// ** Save original Player Data into a variable in order to reset **
// let p1 = new Player(prompt("Enter Player 1 name"), 10);
// let p1 = new Player("Gunjan", 10);
// let p2 = new Player("Soham", 20);
let p1 = Player1;
let p2 = Player2;
